...
class FBUserDataStoreClient extends FBJWTClient {
   ...
   *
   **/
  constructor (serviceToken, serviceSlug, userDataStoreUrl, serviceSecret) {
    super(serviceToken, serviceSlug, userDataStoreUrl, FBUserDataStoreClientError)
    if (!serviceSecret) {
      throw new FBUserDataStoreClientError('No service secret passed to client', {
        error: {
