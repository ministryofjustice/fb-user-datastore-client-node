...
class FBJWTClient {
   ...
   *
   **/
  encrypt (userToken, data) {
    const dataString = JSON.stringify(data)
    const encryptedData = aes256.encrypt(userToken, dataString)
   ...
   *
   **/
  decrypt (userToken, encryptedData) {
    let data
    try {
      data = aes256.decrypt(userToken, encryptedData)
