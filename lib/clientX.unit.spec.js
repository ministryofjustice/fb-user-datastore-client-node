...
// const jwtClient = proxyquire('./fb-jwt-client-node/client', {
//   // 'request-promise-native': request
// })
// const userDataStoreClient = proxyquire('./clientX', {
//   // './fb-jwt-client-node/client': jwtClient
// })
const userDataStoreClient = require('./clientX')
...
const initialisedTests = () => {
  ...
  test('When asking for endpoint urls', t => {
    const getUrl =
  userDataStoreClient.getEndpointUrl('get', {userId})
    t.equal(getUrl, getEndpointUrl, 'it should return the correct value for the get endpoint')
    const setUrl =
  userDataStoreClient.getEndpointUrl('set', {userId})
